...
BUILTIN_SERVERS = [
    ...
    ServerInfo(
        ...
        tools=["list_channels", "post_message", "reply_to_thread",
               "add_reaction", "get_channel_history", "get_thread_replies",
    ...
    ServerInfo(
        ...
        category="location",
        tools=["geocode", "reverse_geocode", "search_places",
               "get_directions", "distance_matrix"],
        requires_auth=True,
    ...
    ServerInfo(
        ...
        tools=["git_status", "git_diff", "git_log", "git_commit",
               "git_add", "git_reset", "git_branch", "git_checkout"],
        source="npm",
    ),
]
